...
export class UpdateHallComponent {

  hallId:any = this.activatedroute.snapshot.params[`id`];
  ...
  updateHall(){
    ...
    this.companyService.updateHall(this.hallId,formData).subscribe(res => {
      this.notification
      .success(
        'SUCCESS',
        'Hall updated successful',
        { nzDuration: 5000 }
      );
  ...
  getHallById(){
    this.companyService.getHallById(this.hallId).subscribe(res => {
      console.log(res);
